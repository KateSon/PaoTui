	...
	<div class="content">
		...
		<div class="list-block">
			...
			<div class="content-padded">
				<a href="javascript:;" class="button button-big button-fill button-round button-danger button-forget">立即找回</a>
			</div>
		</div>
		<div class="text">
...
require(['tiny'], function(tiny){
	...
	$('.button-forget').click(function(){
		...
		$this.addClass("disabled");
		$.post(tiny.getUrl('manage/auth/forget'), {mobile: mobile, password: password, code: code}, function(data){
