					...
					<div class="item-content">
						<div class="item-inner">
							<div class="item-input">
								<input type="text" name="title" placeholder="请输入新的管理员名称" value="<?php  echo $_W['manager']['title'];?>">
							</div>
						</div>
					</div>
				</li>
				...
				<li>
					<div class="item-content">
						<div class="item-inner border-1px-b">
							<div class="item-title">手机号</div>
							<div class="item-input">
								<input type="number" max="11" name="mobile" placeholder="请输入手机号" value="<?php  echo $_W['manager']['mobile'];?>">
							</div>
						</div>
					</div>
				</li>
