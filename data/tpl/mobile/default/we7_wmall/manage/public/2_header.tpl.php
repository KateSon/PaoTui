...
<head>
	...
	<link rel="stylesheet" href="../addons/we7_wmall/template/mobile/manage/static/css/manage.css?t=<?php  echo time();?>" />
	...
	<script type='text/javascript' src="<?php  echo WE7_WMALL_LOCAL?>static/js/iconfig-app.js?t=<?php  echo time();?>"></script>
	...
	<script type='text/javascript' src='../addons/we7_wmall/static/js/components/light7/light7.min.js' charset='utf-8'></script>
	...
	<script type="text/javascript" src="../addons/we7_wmall/static/js/components/light7/common.js?t=100000"></script>
</head>
<body>
