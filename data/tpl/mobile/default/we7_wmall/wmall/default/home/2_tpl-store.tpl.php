<?php defined('IN_IA') or exit('Access Denied');?><script id="tpl-store-list" type="text/html">
		...
		<a href="<{d[i].url}>">
			<div class="store-info row no-gutter">
				<div class="store-img col-25">
					<img src="<?php echo WE7_WMALL_TPL_URL;?>static/img/hm.gif" class="lazyload lazyload-store" data-original="<{d[i].logo}>">
					<{# if(d[i].is_rest == 1){ }>
