...
<div class="clearfix we7-margin-bottom">
	<?php  if(!$_W['isfounder'] && !empty($account_info['pc_limit']) || user_is_vice_founder()) { ?>
	<div class="alert alert-warning hidden">
		...
		可创建 <span class="text-strong"><?php  echo $account_info['maxpcaccount'];?> </span>个PC，已创建<span class="text-strong"> <?php  echo $account_info['pc_num'];?> </span>个，还可创建 <span class="text-strong"><?php  echo $account_info['pc_limit'];?> </span>个PC。
	</div>
	<?php  } ?>
	...
	<?php  if(!empty($account_info['pc_limit']) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
