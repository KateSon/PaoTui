...
<div class="alert alert-info">
	<p><i class="fa fa-exclamation-circle"></i> 绑定域名后，访问app端将使用绑定的域名；</p>
	...
	<p><i class="fa fa-exclamation-circle"></i> 还有最后很重要的一步：将绑定的域名解析到本服务器IP。</p>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<input type="text" ng-model="middleAccount.bind_domain" class="form-control" placeholder="请输入要绑定的域名，无http://" />
