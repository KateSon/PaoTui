				...
				<table class="table table-hover">
					...
					<?php  if(is_array($slides)) { foreach($slides as $slide) { ?>
						<tr>
							...
							<td class="text-right">
								<a href="<?php  echo iurl('dashboard/slide/post', array('id' => $slide['id']))?>" class="btn btn-default btn-sm" title="编辑" data-toggle="tooltip" data-placement="top" ><i class="fa fa-edit"> </i> 编辑</a>
								<a href="<?php  echo iurl('dashboard/slide/del', array('id' => $slide['id']))?>" class="btn btn-default btn-sm js-remove" data-confirm="确定删除该幻灯片?"><i class="fa fa-times"> </i> 删除</a>
							</td>
						</tr>
					<?php  } } ?>
				</table>
