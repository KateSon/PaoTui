				...
				<table class="table table-hover">
					...
					<tr>
						...
						<td style="text-align:right;">
							<a href="<?php  echo iurl('dashboard/nav/post', array('id' => $item['id']))?>" class="btn btn-default btn-sm"><i class="fa fa-edit"> </i> 修改</a>
							<a href="<?php  echo iurl('dashboard/nav/del', array('id' => $item['id']))?>" class="btn btn-default btn-sm js-remove" data-confirm="确定删除该导航?"><i class="fa fa-times"> </i> 删除</a>
						</td>
					</tr>
					<?php  } } ?>
					</tbody>
