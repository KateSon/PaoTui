...
<form action="./index.php?" class="form-horizontal form-filter" id="form1">
	<?php  echo tpl_form_filter_hidden('merchant/current/list');?>
	...
	<div class="form-group">
		...
		<div class="col-sm-9 col-xs-12">
			<div class="btn-group">
				...
				<a href="<?php  echo ifilter_url('trade_type:1');?>" class="btn <?php  if($trade_type == 1) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">外卖店内订单入账</a>
				<a href="<?php  echo ifilter_url('trade_type:4');?>" class="btn <?php  if($trade_type == 4) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">买单订单入账</a>
