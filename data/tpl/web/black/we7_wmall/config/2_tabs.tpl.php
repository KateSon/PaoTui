...
<div class="nav slimscroll">
	...
	<?php  } ?>
		...
		<ul class="menu-item">
			<li <?php  if($_W['_router'] == 'config/member') { ?>class="active"<?php  } ?>>
	...
	<?php  if(check_perm('config.deliveryer')) { ?>
		...
		<ul class="menu-item">
			...
			<li <?php  if($_W['_router'] == 'config/deliveryer/cash') { ?>class="active"<?php  } ?>>
				<a href="<?php  echo iurl('config/deliveryer/cash');?>">提现设置</a>
			</li>
		</ul>
	<?php  } ?>
	<?php  if(check_plugin_exist('managerApp') || check_plugin_exist('customerApp') || check_plugin_exist('deliveryerApp')) { ?>
		...
		<ul class="menu-item">
			...
			<?php  if(check_plugin_exist('customerApp')) { ?>
				<li <?php  if($_W['_router'] == 'config/app/customer') { ?>class="active hide"<?php  } ?>>
					<a href="<?php  echo iurl('config/app/customer');?>">顾客APP</a>
				</li>
			<?php  } ?>
		</ul>
	<?php  } ?>
	<?php  if(check_perm('config.label') || check_perm('config.report' || 'config.help')) { ?>
