...
<div class="tab-pane active" role="tabpanel" id="base">
	<div class="alert alert-warning">
		注意：微信支付需要在公众平台->微信支付->公众号支付 追加一条支付授权目录: <a href="javascript:;" class="js-clip" data-text="<?php  echo $_W['siteroot'];?>app/"><?php  echo $_W['siteroot'];?>app/</a>
	</div>
	<h3>微信支付参数</h3>
...
<div class="form-group">
	...
	<div class="col-sm-9 col-xs-12">
		...
		<span class="help-block">新^睿^社^区^提^示：这里填写子商户的Mch_Id</span>
	</div>
</div>
<div class="form-group">
	<label class="col-xs-12 col-sm-3 col-md-2 control-label">微信支付密钥(APIKEY)</label>
