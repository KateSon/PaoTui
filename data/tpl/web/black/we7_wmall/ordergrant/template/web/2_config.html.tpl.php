...
<div class="page clearfix ordergrant">
	...
	<form class="form-horizontal form form-validate" id="form1" action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="radio radio-inline">
					<input type="radio" value="1" name="status" id="status-1" <?php  if($config_ordergrant['status'] == 1) { ?>checked<?php  } ?>>
					<label for="status-1">开启</label>
				</div>
				<div class="radio radio-inline">
					<input type="radio" value="0" name="status" id="status-0" <?php  if($config_ordergrant['status'] == 0) { ?>checked<?php  } ?>>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="radio radio-inline">
					<input type="radio" value="0" name="cycle" id="cycle-0" <?php  if($config_ordergrant['cycle'] == 0) { ?>checked<?php  } ?>>
					<label for="cycle-0">不限</label>
				</div>
				<div class="radio radio-inline">
					<input type="radio" value="1" name="cycle" id="cycle-1" <?php  if($config_ordergrant['cycle'] == 1) { ?>checked<?php  } ?>>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="radio radio-inline">
					<input type="radio" value="credit1" name="grantType" id="credit1" <?php  if($config_ordergrant['grantType'] == credit1 || empty($config_ordergrant['grantType'])) { ?>checked<?php  } ?>>
					<label for="credit1">积分</label>
				</div>
				<div class="radio radio-inline">
					<input type="radio" value="credit2" name="grantType" id="credit2" <?php  if($config_ordergrant['grantType'] == credit2) { ?>checked<?php  } ?>>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					...
					<input class="form-control" type="number" value="<?php  echo $config_ordergrant['first_order_grant'];?>" name="first_order_grant">
					<span class="input-group-addon border-0-lr"> 日常奖励</span>
					<input class="form-control" type="number" value="<?php  echo $config_ordergrant['days_order_grant'];?>" name="days_order_grant">
				</div>
			</div>
		</div>
		<div class="form-group reward">
			...
			<div class="col-sm-9 col-xs-12">
				<div id="continuous-container">
					<?php  if(!empty($config_ordergrant['continuous'])) { ?>
						<?php  if(is_array($config_ordergrant['continuous'])) { foreach($config_ordergrant['continuous'] as $continuous) { ?>
							<div class="input-group">
								<span class="input-group-addon">连续下单</span>
								<input class="form-control" type="number" value="<?php  echo $continuous['days'];?>" name="continuous_days[]">
								<span class="input-group-addon border-0-lr">天 奖励</span>
								<input class="form-control" type="number" value="<?php  echo $continuous['grant'];?>" name="continuous_grant[]">
		...
		<div class="form-group reward">
			...
			<div class="col-sm-9 col-xs-12">
				<div id="all-container">
					<?php  if(!empty($config_ordergrant['all'])) { ?>
						<?php  if(is_array($config_ordergrant['all'])) { foreach($config_ordergrant['all'] as $all) { ?>
							<div class="input-group">
								<span class="input-group-addon">累计下单</span>
								<input class="form-control" type="number" value="<?php  echo $all['days'];?>" name="all_days[]">
								<span class="input-group-addon border-0-lr">天 奖励</span>
								<input class="form-control" type="number" value="<?php  echo $all['grant'];?>" name="all_grant[]">
								<div class="input-group-btn">
									<span class="btn btn-danger btn-del">删除</span>
								</div>
							</div>
		...
		<div class="form-group reward">
			...
			<div class="col-sm-9 col-xs-12">
				<div id="special-container">
					<?php  if(!empty($config_ordergrant['special'])) { ?>
						<?php  if(is_array($config_ordergrant['special'])) { foreach($config_ordergrant['special'] as $special) { ?>
							<div class="input-group">
								<span class="input-group-addon">日期</span>
								<input type="text" name="special_date[]" value="<?php  echo $special['date'];?>" placeholder="请选择日期时间" readonly="readonly" class="datetimepicker form-control">
								<span class="input-group-addon border-0-lr">标题</span>
								<input class="form-control" value="<?php  echo $special['title'];?>" placeholder="非必填" name="special_title[]">
								<span class="input-group-addon border-0-lr">颜色</span>
								<input class="form-control select-color" value="<?php  echo $special['color'];?>" type="color" name="special_color[]">
								<span class="input-group-addon border-0-lr">奖励</span>
								<input class="form-control" type="number" value="<?php  echo $special['grant'];?>" name="special_grant[]">
								<div class="input-group-btn">
									<span class="btn btn-danger btn-del">删除</span>
								</div>
							</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<input type="text" name="title" value="<?php  echo $config_ordergrant['ordergrant_share']['title'];?>" class="form-control" required="true">
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-12 col-sm-3 col-md-2 control-label">分享描述</label>
			<div class="col-sm-9 col-xs-12">
				<input type="text" name="desc" value="<?php  echo $config_ordergrant['ordergrant_share']['desc'];?>" class="form-control">
			</div>
		</div>
		<div class="form-group">
