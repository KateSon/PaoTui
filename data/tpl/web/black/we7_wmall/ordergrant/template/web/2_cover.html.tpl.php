...
<div class="page clearfix">
	<form class="form-horizontal form" id="form1" action="" method="post" enctype="multipart/form-data">
		<h3 class="margin-t-0">分享订单入口</h3>
		<div class="form-group">
			<label class="col-xs-12 col-sm-3 col-md-2 control-label">直接URL</label>
			<div class="col-sm-9 col-xs-12">
				<p class="form-control-static js-clip" data-text="<?php  echo $urls['share'];?>" title="点击复制">
					<a href="javascript:;"><?php  echo $urls['share'];?></a>
				</p>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="qrcode-block js-qrcode" data-text="<?php  echo $urls['share'];?>"></div>
			</div>
		</div>
	</form>
</div>
