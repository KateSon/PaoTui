...
<div class="page clearfix">
	...
	<h3>基本设置</h3>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					<input type="number" name="share_redpacket_min" value="<?php  echo $activity['share_redpacket_min'];?>" class="form-control"  required="true" number="true">
					<span class="input-group-addon">至</span>
					<input type="number" name="share_redpacket_max" value="<?php  echo $activity['share_redpacket_max'];?>" class="form-control"  required="true" number="true">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					...
					<input type="number" name="share_redpacket_condition" value="<?php  echo $activity['share_redpacket_condition'];?>" class="form-control"  required="true" number="true">
					<span class="input-group-addon">元</span>
				</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					<input class="form-control" type="number" value="<?php  echo $activity['share_redpacket_days_limit'];?>" name="share_redpacket_days_limit" required="true" digtis="true" aria-required="true">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					<input type="number" name="follow_redpacket_min" value="<?php  echo $activity['follow_redpacket_min'];?>" class="form-control" required="true" number="true">
					<span class="input-group-addon">至</span>
					<input type="number" name="follow_redpacket_max" value="<?php  echo $activity['follow_redpacket_max'];?>" class="form-control" required="true" number="true">
					<span class="input-group-addon">元</span>
				</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					<input class="form-control" type="number" value="<?php  echo $activity['follow_redpacket_days_limit'];?>" name="follow_redpacket_days_limit" required="true" digtis="true">
					<span class="input-group-addon">天</span>
				</div>
...
<form action="./index.php" class="form-horizontal form-invite">
	...
	<div class="form-group">
		...
		<div class="col-sm-9 col-xs-12">
			<div class="btn-group">
				...
				<a href="<?php  echo ifilter_url('status:1');?>" class="btn <?php  if($status == 1) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">已下单</a>
				<a href="<?php  echo ifilter_url('status:0');?>" class="btn <?php  if($status == 0) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">未下单</a>
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-4 col-xs-4">
			<input type="text" name="keyword" class="form-control" value="<?php  echo $keyword;?>" placeholder="搜索邀请人的姓名、昵称、手机号">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="panel panel-table">
		<div class="panel-body table-responsive js-table">
			...
			<table class="table table-hover">
				...
				<tbody>
				<?php  if(is_array($invites)) { foreach($invites as $invite) { ?>
				<tr>
					<td><img width="50" height="50" src="<?php  echo $invite['share_avatar'];?>" alt="">&nbsp;&nbsp;<?php  echo $invite['share_realname'];?></td>
					<td><img width="50" height="50" src="<?php  echo $invite['follow_avatar'];?>" alt="">&nbsp;&nbsp;<?php  echo $invite['follow_realname'];?></td>
					<td><?php  echo $invite['share_redpacket_discount'];?>元</td>
					<td><?php  echo $invite['follow_redpacket_discount'];?>元</td>
				</tr>
				<?php  } } ?>
				</tbody>
			</table>
...
<form action="./index.php" class="form-horizontal form-invite">
	...
	<div class="form-group">
		<label class="col-xs-12 col-sm-3 col-md-2 control-label">搜索</label>
		<div class="col-sm-4 col-xs-4">
			<input type="text" name="keyword" value="<?php  echo $keyword;?>" class="form-control" placeholder="搜索邀请人的姓名、昵称、手机号">
		</div>
	</div>
	<div class="form-group">
		<label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
			...
			<?php  } else { ?>
				<table class="table table-hover">
					...
					<?php  if(is_array($rankings)) { foreach($rankings as $ranking) { ?>
						<tr>
							<td><img width="50" height="50" src="<?php  echo $ranking['share_avatar']?>" alt="">&nbsp;&nbsp;<?php  echo $ranking['share_realname'];?></td>
							<td><?php  echo $ranking['total'];?>人</td>
							<td><?php  echo $ranking['has_ordered'];?>人</td>
							<td><?php  echo $ranking['pre_sum'];?>元</td>
							<td><?php  echo $ranking['sum'];?>元</td>
