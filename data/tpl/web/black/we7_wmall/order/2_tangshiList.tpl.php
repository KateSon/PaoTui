	...
	<div class="col-md-8">
		...
		<div class="panel-order">
			...
			<div class="btn-area">
				...
				<?php  } ?>
				<?php  if($order['refund_status'] > 0 && $order['refund_status'] < 3) { ?>
				...
				<?php  } ?>
				<a href="<?php  echo iurl('order/tangshi/print', array('id' => $order['id']));?>" class="btn btn-primary btn-sm js-post" data-confirm="确定打印订单吗?"><i class="fa fa-print"></i> ( <?php  echo $order['print_nums'];?> )</a>
