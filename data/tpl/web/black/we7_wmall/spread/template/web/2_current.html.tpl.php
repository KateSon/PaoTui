...
<form action="./index.php?" class="form-horizontal form-filter" id="form1">
	<?php  echo tpl_form_filter_hidden('spread/current/index');?>
	...
	<div class="form-group">
		...
		<div class="col-sm-9 col-xs-12">
			<div class="btn-group">
				...
				<a href="<?php  echo ifilter_url('trade_type:1');?>" class="btn <?php  if($trade_type == 1) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>">推广佣金入账</a>
			...
			<table class="table table-hover">
				...
				<?php  if(is_array($records)) { foreach($records as $record) { ?>
					<tr>
						...
						<td>
							<img src="<?php  echo $record['avatar'];?>" alt="" width="50" height="50" style="border-radius: 100%"/>
							<?php  echo $record['realname'];?>
						</td>
						<td><?php  echo $record['nickname'];?></td>
						<td>
							<span class="<?php  echo spread_trade_type($record['trade_type'], 'css')?>"><?php  echo spread_trade_type($record['trade_type'], 'text')?></span>
						</td>
						<td>
