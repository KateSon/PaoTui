...
<div id="js-goods-seller" ng-controller="goodsSellerCtrl" ng-cloak>
	<ul class="we7-page-tab">
		...
		<li <?php  if($type == STORE_TYPE_ACCOUNT_RENEW) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('goodsSeller', array('type' => STORE_TYPE_ACCOUNT_RENEW,'direct' => '1'))?>">公众号续费</a></li>
		<li <?php  if($type == STORE_TYPE_WXAPP_RENEW) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('goodsSeller', array('type' => STORE_TYPE_WXAPP_RENEW,'direct' => '1'))?>">小程序续费</a></li>
	</ul>
	...
	<table class="table we7-table vertical-middle">
		...
		<tr>
			<td>
				...
				<?php  } else if(in_array($_GPC['type'], array(STORE_TYPE_PACKAGE, STORE_TYPE_ACCOUNT, STORE_TYPE_WXAPP, STORE_TYPE_ACCOUNT_RENEW, STORE_TYPE_WXAPP_RENEW))) { ?>
			...
			<td>
				...
				<?php  if($goods['unit'] == 'month') { ?><?php  if($type == STORE_TYPE_ACCOUNT_RENEW) { ?><?php  echo $goods['account_num'];?><?php  } else if($type == STORE_TYPE_WXAPP_RENEW) { ?><?php  echo $goods['wxapp_num'];?><?php  } ?>月
				<?php  } else if($goods['unit'] == 'ten_thousand') { ?>
				<?php  echo $goods['api_num'];?>万次
				<?php  } else if($goods['unit'] == 'day') { ?><?php  if($type == STORE_TYPE_ACCOUNT_RENEW) { ?><?php  echo $goods['account_num'];?><?php  } else if($type == STORE_TYPE_WXAPP_RENEW) { ?><?php  echo $goods['wxapp_num'];?><?php  } ?>天
				<?php  } else if($goods['unit'] == 'year') { ?><?php  if($type == STORE_TYPE_ACCOUNT_RENEW) { ?><?php  echo $goods['account_num'];?><?php  } else if($type == STORE_TYPE_WXAPP_RENEW) { ?><?php  echo $goods['wxapp_num'];?><?php  } ?>年
				<?php  } ?>
			</td>
			<td ng-if="!status">
