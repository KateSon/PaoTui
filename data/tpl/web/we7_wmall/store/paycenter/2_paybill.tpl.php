...
<form action="./index.php?" class="form-horizontal form-filter">
	<?php  echo tpl_form_filter_hidden('store/paycenter/paybill/index');?>
...
<div class="clearfix order-list panel-table">
	...
	<div class="panel-body table-responsive js-table">
		<table class="table table-hover">
			...
			<tr>
				<td><img src="<?php  echo tomedia($order['avatar']);?>" alt="" width="50"/><?php  echo $order['nickname'];?></td>
				<td><span class="<?php  echo to_paytype($order['pay_type'], 'css')?>"><?php  echo to_paytype($order['pay_type'], 'text')?></span></td>
