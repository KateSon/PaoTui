...
if ($op == 'index') {
	...
	while ($starttime <= $i) {
		if (empty($records_temp[$i])) {
			$records[] = array('stat_day' => $i, 'total_success_order' => 0, 'total_fee' => 0, 'final_fee' => 0, 'plateform_serve_fee' => 0, 'plateform_deliveryer_fee' => 0, 'plateform_delivery_fee' => 0, 'plateform_discount_fee' => 0, 'agent_discount_fee' => 0, 'agent_serve_fee' => 0, 'agent_final_fee' => 0, 'refund_fee' => 0);
		}
		else {
