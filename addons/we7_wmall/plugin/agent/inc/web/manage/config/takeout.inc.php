...
if ($op == 'order') {
	...
	if ($_W['ispost']) {
		$order = array(
			'notify_rule_clerk'                     => array('notify_delay' => intval($_GPC['clerk']['notify_delay']), 'notify_frequency' => intval($_GPC['clerk']['notify_frequency']), 'notify_total' => intval($_GPC['clerk']['notify_total'])),
			'notify_rule_deliveryer'                => array('notify_delay' => intval($_GPC['deliveryer']['notify_delay']), 'notify_frequency' => intval($_GPC['deliveryer']['notify_frequency']), 'notify_total' => intval($_GPC['deliveryer']['notify_total'])),
