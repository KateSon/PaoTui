	...
	if ($_W['ispost']) {
		...
		$config_payment = array(
			'wechat' => array(
				...
				'default' => array('appid' => trim($_GPC['wxapp']['wechat']['appid']), 'appsecret' => trim($_GPC['wxapp']['wechat']['appsecret']), 'mchid' => trim($_GPC['wxapp']['wechat']['mchid']), 'apikey' => trim($_GPC['wxapp']['wechat']['apikey']), 'apiclient_cert' => $config_old_payment['wechat']['default']['apiclient_cert'], 'apiclient_key' => $config_old_payment['wechat']['default']['apiclient_key'], 'rootca' => $config_old_payment['wechat']['default']['rootca'])
				),
			'wxapp'  => array()
			);
