...
if ($op == 'create') {
	...
	$order = array('uniacid' => $_W['uniacid'], 'agentid' => $store['agentid'], 'acid' => $_W['acid'], 'sid' => $sid, 'uid' => $_W['member']['uid'], 'mall_first_order' => $_W['member']['is_mall_newmember'], 'ordersn' => date('YmdHis') . random(6, true), 'serial_sn' => store_order_serial_sn($sid), 'code' => random(4, true), 'order_type' => 1, 'openid' => $_W['openid'], 'mobile' => $extra['mobile'], 'username' => $extra['username'], 'sex' => '', 'address' => $extra['address'], 'location_x' => $address['location_x'], 'location_y' => $address['location_y'], 'delivery_day' => date('Y-m-d'), 'delivery_time' => '尽快送达', 'delivery_fee' => $extra['delivery_fee'], 'pack_fee' => $store['pack_price'], 'pay_type' => 'delivery', 'is_pay' => 1, 'num' => $cart['num'], 'distance' => $address['distance'], 'box_price' => $cart['box_price'], 'price' => $cart['price'], 'extra_fee' => $extra_fee, 'total_fee' => $total_fee, 'discount_fee' => 0, 'store_discount_fee' => 0, 'plateform_discount_fee' => 0, 'agent_discount_fee' => 0, 'final_fee' => $total_fee, 'vip_free_delivery_fee' => 0, 'delivery_type' => $store['delivery_mode'], 'status' => 1, 'is_comment' => 0, 'invoice' => '', 'order_channel' => 'plateformCreate', 'addtime' => TIMESTAMP, 'paytime' => TIMESTAMP, 'data' => iserializer(array(
