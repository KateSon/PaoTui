...
if ($ta == 'index') {
	...
	if ($_W['isajax']) {
		...
		$stickData = array('uniacid' => $_W['uniacid'], 'sid' => $sid, 'type' => 'stick', 'displayorder' => $displayorder, 'title' => '置顶No.' . $displayorder . ',' . $day . '天', 'status' => 0, 'addtime' => TIMESTAMP, 'starttime' => TIMESTAMP, 'endtime' => TIMESTAMP, 'is_pay' => 0, 'order_sn' => date('YmdHis', time()) . random(6, true), 'final_fee' => $finalfee, 'pay_type' => $pay_type, 'days' => $day, 'data' => '');
