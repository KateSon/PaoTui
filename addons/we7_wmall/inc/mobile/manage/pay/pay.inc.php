...
$routers = array(
	'advertise' => array('title' => $order['title'] . '-' . $record['order_sn'], 'url_pay' => imurl('manage/pay/pay', array('id' => $order['id'], 'order_type' => 'advertise'), true), 'url_detail' => imurl('manage/advertise/' . $order['type'], array('id' => $order['id']), true))
	);
